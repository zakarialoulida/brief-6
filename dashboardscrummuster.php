      ...
      <main class="flex-1 ">
        ...
        <div class="bg-gray-100 py-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          if (isset($_POST['deleteId'])) {
            ...
            $updateUsersQuery = "UPDATE users SET équipe_ID = NULL WHERE  équipe_ID= '$deleteequipe'";
            $resultUsers = mysqli_query($sql, $updateUsersQuery);


            if ($resultUsers) {
              $deleteQuery = "DELETE FROM equipes WHERE équipe_ID = '$deleteequipe'";
              $resultProjects = mysqli_query($sql, $deleteQuery);
            }
          }
          ?>
